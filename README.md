...
|-------|---------------------|---------------------------------------------------------|-------------------------------------------------------------------------|
| 🟢    | Ahmed Raza (default) | Latest deployment of the template here on GitHub pages. | [Preview](my-portfolio-inky-one-47.vercel.app)     |
...
This template was created by and is maintained by **[Ahmed Raza](https://github.com/Ahmed-Raza-2012)**.
